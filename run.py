...
def drawpointstoframe(points, frame):
    if points is not None:
        ...
        if rotate == True:
            ...
            points1, points2, _, _ = detector(image_flip)
            points = points1
...
while hasFrame:
    ...
    cv2.putText(frame, "SEC: ", (480, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (200, 40, 60), 2)
    cv2.putText(frame, str(round(end - start, 2)), (560, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (200, 40, 60), 2)
